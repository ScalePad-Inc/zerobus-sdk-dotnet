...
public class IntegrationTests
{
    ...
    [Test]
    public async Task SuccessfulStreamCreationAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task TimeoutedStreamCreationAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task NonRetriableErrorDuringStreamCreationAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task RetriableErrorWithoutRecoveryDuringStreamCreationAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task IdempotentCloseAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task IngestAfterCloseAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
        ...
        // Ingesting after close should throw.
        Assert.That(async () => await stream.IngestRecordAsync("test record data"u8.ToArray()),
            Throws.InstanceOf<Exception>());
    }
    ...
    [Test]
    public async Task IngestSingleRecordAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task IngestMultipleRecordsAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task IngestBatchRecordsAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
    ...
    [Test]
    public async Task IngestRecordsAfterCloseAsync()
    {
        await using var fixture = await MockServerFixture.StartAsync();
        ...
        Assert.That(async () => await stream.IngestRecordsAsync(batch),
            Throws.InstanceOf<Exception>());
    }
    ...
    [Test]
    public async Task RecreateStreamAsync_OriginalDisposed_RecreatedStreamUsable()
    {
        await using var fixture = await MockServerFixture.StartAsync();
        ...
        var stream = await sdk.CreateStreamWithHeadersProviderAsync(tableProps, new TestHeadersProvider(), options);
        await Native.NativeInterop.StreamCloseAsync(stream.NativePointer); // simulate stream being closed by some external factor
        await using var recreatedStream = await sdk.RecreateStreamAsync(stream);

        Assert.That(recreatedStream, Is.Not.Null);
        Assert.That(recreatedStream, Is.Not.SameAs(stream));

        Assert.That(async () => await stream.IngestRecordAsync("old stream"u8.ToArray()),
            Throws.InstanceOf<ObjectDisposedException>());
    ...
    [Test]
    public async Task RecreateStreamAsync_ActiveStream_ThrowsZerobusException()
    {
        await using var fixture = await MockServerFixture.StartAsync();
